...
<p>After bringing in the stl file, I uploaded it to the CNC mill computer. Here are some pictures showing the process of making paths for the drill to go through:</p>

<img src="cncbowl.jpg" alt="Finished Product" style="height: 500px; max-width: 100%">
<img src="cncbowl.jpg" alt="Finished Product" style="height: 500px; max-width: 100%">

<p>Here are some pictures and a timelapse of the car mold being made:</p>
