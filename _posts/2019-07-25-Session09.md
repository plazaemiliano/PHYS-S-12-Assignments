...
<xmp>#include (less-than) symbolServo.h(more-than symbol);
...
<xmp>#include (less-than)Stepper.h(more-than symbol) // Include the header file
...
if (potVal(more-than symbol)350)
  stepper.step(5);
