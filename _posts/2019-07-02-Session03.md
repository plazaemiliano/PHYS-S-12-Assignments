...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'Lab 3 ~7/02~')">Lab 3 ~7/02~</button>
</div>
...
<p>The second part of class one of Robert's colleagues showed us many examples of his work with press fit designs. He made 3D designs with the use of triangular and rectangular press fit shapes. These are two of his own 3D designs:</p>
