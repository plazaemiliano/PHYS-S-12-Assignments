...
<div id="Lab 3 pt.2 ~7/08~" class="tabcontent">
  <p>In today's lab, we individually improved our laser cutting techniques and Fusion 360 skills. We were assigned to make our own press fit kits to test our design and laser cutting skills. I decided to make something that will hint to my prototype, so I made a box that can be easily taken apart and could hold an Arduino UNO inside. This will help me find a good size for the body of the 2 motor vehicle I will prototype. I decided to design the box with a different press-fit method. I will make the slots for the side panels in the interior of the faces of the four long faces covering the box. Then I made the other two end faces have four arms that will fit in these interior slots and will hod the whole box together. Here is the design on Fusion 360:</p>
