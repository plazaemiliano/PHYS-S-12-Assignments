...
<p>Additionally, I created a new main body for the press fit kit because I realized I needed to fit the bread board and other medium sized components inside of the car so it could be managable. I decided to design it much longer and to have bigger pressfit holes to have more friction and ulitmately so the car holds itself together better. Below is a screenshot of the design I came up with:</p>

<img src="newbody.png" alt="Finished Product" style="height: 400px; max-width: 100%">
