...
<img src="Blink Arduino.png" alt="Blink Code" style="height: 200px; max-width: 48%">
<img src="Dim Arduino.png" alt="Dim Code" style="height: 200px; max-width: 48%">
<img src="Fade Arduino.png" alt="Fade Arduino" style="height: 200px; max-width: 48%">
