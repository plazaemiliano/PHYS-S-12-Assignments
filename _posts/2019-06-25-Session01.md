...
Blinking Arduino Code: </p>
<img src="Blink Arduino.png" alt="Blink Code" style="height: 300px; max-width: 100%">
</p>Dim Arduino Code: </p>
<img src="Dim Arduino.png" alt="Dim Code" style="height: 300px; max-width: 100%">
